	...
	public void update()
	{
		...
		if(planets!= null)
		{
			...
			if(isKeyPressed("S"))
			{
				...
				{
					resetKeys();
					ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(new File("levels\\" + JOptionPane.showInputDialog(this, "Save As: "))));
			...
			if(isKeyPressed("L"))
			{
				try
				{
					...
					ObjectInputStream ois = new ObjectInputStream(new FileInputStream(new File("levels\\" +JOptionPane.showInputDialog(this, "Load: "))));
